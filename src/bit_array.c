    ...
    #define LOGGED_SUBTEST_START  \
        LOGGED_FUNCTION_START("%p, %zu, %zu, %zu, %u",  \
                              bit_array,  \
                              length,  \
                              hole_start,  \
                              hole_end,  \
    ...
    static void check_bit_array_range_alleq(const word_t bit_array[],
        ...
        LOGGED_SUBTEST_START
            ...
            #define all(start, end, value)  \
                bit_array_range_alleq(bit_array,  \
                                      length,  \
                                      (start),  \
                                      (end),  \
                                      (value))

            debug("Main region, before hole...");
            ...
            debug("Shifting hole_start by -1...");
            if (hole_start > 0) {
                ensure(all(BIT_ARRAY_START,
    ...
    static void check_bit_array_find_first(const word_t bit_array[],
        ...
        LOGGED_SUBTEST_START
            ...
            debug("Finding the first bit that's set to the main value...");
            ...
            debug("Finding the first bit that's set to the hole value...");
    ...
    static void check_bit_array_set(word_t bit_array[],
        ...
        LOGGED_SUBTEST_START
            ...
            debugf("Setting a random bit at index %zu to the hole value...",
                   hole_idx);
            ...
            debug("...then checking the resulting bit pattern");
            for (size_t idx = 0; idx < length; ++idx) {
                tracef("- At index %zu.", idx);
                bool expected;
                if (idx == hole_idx) {
    ...
    static void test_bit_array_with_hole(word_t bit_array[],
        ...
        LOGGED_SUBTEST_START
            ...
            debug("Testing bit_array_range_alleq()...");
            ...
            debug("Testing bit_array_find_first()...");
            ...
            debug("Testing bit_array_find_next()...");
    ...
    static void test_bit_array(word_t bit_array[], size_t length) {
        LOGGED_FUNCTION_START("%p, %zu", bit_array, length)
