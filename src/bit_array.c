    ...
    static void check_bit_array_get(word_t bit_array[],
                                    size_t length,
                                    size_t hole_start,
                                    size_t hole_end,
                                    bool main_value) {
    ...
    static void check_bit_array_count(word_t bit_array[],
                                      size_t length,
                                      size_t hole_start,
                                      size_t hole_end,
                                      bool main_value) {
    ...
    static void check_bit_array_range_alleq(word_t bit_array[],
                                            size_t length,
                                            size_t hole_start,
                                            size_t hole_end,
                                            bool main_value) {
    ...
    static void check_bit_array_find_first(word_t bit_array[],
                                           size_t length,
                                           size_t hole_start,
                                           size_t hole_end,
                                           bool main_value) {
    ...
    /// Sub-test of test_bit_array_with_hole() that exercises
    /// bit_array_find_next()
    static void check_bit_array_find_next(word_t bit_array[],
                                          size_t length,
                                          size_t hole_start,
                                          size_t hole_end,
                                          bool main_value) {
